// add-whatsapp-button.js
const fs = require("fs");
const path = require("path");

console.log("💬 Adicionando botão interativo e widget flutuante do WhatsApp na página pública...\n");

const targetPath = path.join(process.cwd(), "src/components/booking/public-booking-client-view.tsx");
...
console.log("✓ Botão e Widget do WhatsApp adicionados com sucesso!");